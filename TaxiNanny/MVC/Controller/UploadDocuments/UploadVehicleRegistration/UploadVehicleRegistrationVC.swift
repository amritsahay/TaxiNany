//
//  UploadVehicleRegistrationVC.swift
//  TaxiNanny
//
...
class UploadVehicleRegistrationVC: UIViewController {
        ...
        if let viewControllers = self.navigationController?.viewControllers
        {
            for viewController in viewControllers
            {
                if viewController.isKind(of:UploadDocumentsVC.self)
                {
                    ...
                    uploadDocumentVC.updateDocumentStatus(document_name:"Vehicle Registration")
...
extension UploadVehicleRegistrationVC:UIImagePickerControllerDelegate
{
...
extension UploadVehicleRegistrationVC:UINavigationControllerDelegate
{
    
}

// webseevice
extension UploadVehicleRegistrationVC
{
    func UploadVehiclePermitApi(urlString:URL) {
        ...
        let url = "http://178.128.116.149/taxinanny1/public/api/addvehicledocumentdriver"
        
        //  driver_id,vehicle_id,vehicle_registration_document (pdf)
        ...
        Alamofire.upload(
            multipartFormData: { multipartFormData in
                ...
                multipartFormData.append(data, withName: "vehicle_registration_document")
        },
            to: url,
            method:.post,
...
extension UploadVehicleRegistrationVC:UIDocumentMenuDelegate,UIDocumentPickerDelegate
{
